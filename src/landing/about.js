    ...
    return (
      <div className="about">
        ...
        <div onClick={this.handleGoalClick} className="smartgoals-info">
          ...
          <ul>
            <li>
              Smart Goal Format: Students easily add new smart goals following
              the specific, measurable, attainable, relevant, and time based
              format.
            </li>
            <li>
              Based on Data: As students make and reflect on their goals, the
              relevant data displays automatically allowing for data driven
              goals and reflections.
            </li>
            <li>
              Student/Teacher Communication: Teachers can send comments to each
              student goal and students can submit end of goal reflections.
            </li>
          </ul>
        </div>
        ...
        <div onClick={this.handleDataClick} className="datatracking-info">
          ...
          <ul>
            <li>
              Assignment Log: Students can enter and edit all of their graded
              assignments in an easy to maintain assignment log.
            </li>
            <li>
              Data Views: Students can view graphs of their progress that
              automatically populate based on their assignment log.
            </li>
            <li>
              Data View Types: All Assignments, Classwork Progress, Homework
              Progress, Projects Progress, Assessments Progress, and Total Grade
              Calculation.
            </li>
          </ul>
        </div>
        ...
        <div onClick={this.handleFutureClick} className="future-info">
          ...
          <ul>
            <li>
              Multiple Students: Add an entire class of students with unique
              usernames and passwords.
            </li>
            <li>
              Expanded Teacher Options: Teachers can create unique classes with
              specific grading categories and weights.
            </li>
            <li>
              Expanded Student Options: Student goal reflections expanded to
              push student thinking about their goal accomplishments.
            </li>
          </ul>
        </div>
      </div>
